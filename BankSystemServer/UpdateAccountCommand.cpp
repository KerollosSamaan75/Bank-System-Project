...
UpdateAccountCommand::UpdateAccountCommand(BankDataBase &db) : dataBase(db) {}

void UpdateAccountCommand::execute(const QStringList &RequestParts, QString &statusMessage)
{
