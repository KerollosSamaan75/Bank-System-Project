...
GetTransactionHistoryCommand::GetTransactionHistoryCommand(BankDataBase &db) : dataBase(db) {}

void GetTransactionHistoryCommand::execute(const QStringList &RequestParts, QString &statusMessage)
{
